...
class AccesoDatos
{
    ...
    {
        try {
            $this->_objetoPDO = new PDO('mysql:host=us-cdbr-iron-east-04.cleardb.net;dbname=lacomanda;charset=utf8', 'b9279e001d6258', '5376b83f', array(PDO::ATTR_EMULATE_PREPARES => false,PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
